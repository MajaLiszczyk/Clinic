...
namespace ClinicAPI.Services.Interfaces
{
    public interface IDiagnosticTestTypeService
    {
        ...
        public Task<(bool Confirmed, string Response, DiagnosticTestType? patient)> CreateDiagnosticTestType(CreateDiagnosticTestTypeDto testType);
        public Task<(bool Confirmed, string Response)> UpdateDiagnosticTestType(UpdateDiagnosticTestTypeDto testType);
