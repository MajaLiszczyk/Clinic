...
@Component({
  selector: 'app-registrant-patients-old',
  standalone: true,
  imports: [GetPatientsComponent, AddPatientComponent, HttpClientModule,  ReactiveFormsModule, CommonModule, RouterLink],
  templateUrl: './registrant-patients-old.component.html',
  styleUrl: './registrant-patients-old.component.css'
})
export class RegistrantPatientsOldComponent {
